...
import 'package:chat_location/features/auth/presentaation/component/login_button.dart';
...
class LoginPageT extends ConsumerStatefulWidget {
  const LoginPageT({super.key});

  static const String routeName = '/loginT';
  static const String pageName = "loginT";
  @override
  ConsumerState<LoginPageT> createState() => _LoginPageState();
}

class _LoginPageState extends ConsumerState<LoginPageT> {
