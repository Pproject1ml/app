...
import 'package:timeago/timeago.dart' as timeago;
 Widget chatBubbleBox({required String message, Color backgroundColor = TTColors.gray6,Color textColor = Colors.black, int unread =-1,required DateTime time, bool reversed = false}){
  return Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    message,
                    style: TTTextTheme.lightTextTheme.labelMedium?.copyWith(color:textColor )
                  ),
                ),
                SizedBox(
                  width: widthRatio(4),
